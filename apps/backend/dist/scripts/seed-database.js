...
async function seedDatabase() {
    try {
        ...
        for (const category of categories) {
            const createdCategory = await database_1.default.category.upsert({
        ...
        await database_1.default.inventoryActivity.deleteMany({});
        await database_1.default.inventory.deleteMany({});
        await database_1.default.cartItem.deleteMany({});
        await database_1.default.orderItem.deleteMany({});
        await database_1.default.review.deleteMany({});
        ...
        const iphoneProducts = [
            ...
            {
                name: 'iPhone 7',
                description: 'Apple iPhone 7, 4.7-inch display, A10 Fusion chip',
                price: 2500000,
            ...
            {
                name: 'iPhone 7 Plus',
                description: 'Apple iPhone 7 Plus, 5.5-inch display, A10 Fusion chip',
                price: 3500000,
                categoryName: 'iPhone 7 Series',
            ...
            {
                name: 'iPhone 8',
                description: 'Apple iPhone 8, 4.7-inch display, A11 Bionic chip',
                price: 3800000,
            ...
            {
                name: 'iPhone 8 Plus',
                description: 'Apple iPhone 8 Plus, 5.5-inch display, A11 Bionic chip',
                price: 4800000,
                categoryName: 'iPhone 8 Series',
            ...
            {
                name: 'iPhone X',
                description: 'Apple iPhone X, 5.8-inch Super Retina display, Face ID',
                price: 5500000,
            ...
            {
                name: 'iPhone XR',
                description: 'Apple iPhone XR, 6.1-inch Liquid Retina display, Face ID',
                price: 6000000,
                categoryName: 'iPhone X Series',
            ...
            {
                name: 'iPhone XS',
                description: 'Apple iPhone XS, 5.8-inch Super Retina display, Face ID',
                price: 6500000,
                categoryName: 'iPhone X Series',
            ...
            {
                name: 'iPhone XS Max',
                description: 'Apple iPhone XS Max, 6.5-inch Super Retina display, Face ID',
                price: 7500000,
                categoryName: 'iPhone X Series',
            ...
            {
                name: 'iPhone 11',
                description: 'Apple iPhone 11, 6.1-inch Liquid Retina display, A13 Bionic chip',
                price: 8500000,
            ...
            {
                name: 'iPhone 11 Pro',
                description: 'Apple iPhone 11 Pro, 5.8-inch Super Retina XDR display, triple camera',
                price: 10500000,
                categoryName: 'iPhone 11 Series',
            ...
            },
            {
                ...
                description: 'Apple iPhone 11 Pro Max, 6.5-inch Super Retina XDR display, triple camera',
                price: 12000000,
                categoryName: 'iPhone 11 Series',
            ...
            {
                name: 'iPhone SE (2020)',
                description: 'Apple iPhone SE 2020, 4.7-inch display, A13 Bionic chip',
                price: 4500000,
            ...
            {
                name: 'iPhone SE (2022)',
                description: 'Apple iPhone SE 2022, 4.7-inch display, A15 Bionic chip',
                price: 7000000,
                categoryName: 'iPhone SE Series',
            ...
            {
                name: 'iPhone 12',
                description: 'Apple iPhone 12, 6.1-inch Super Retina XDR display, 5G',
                price: 10500000,
            ...
            {
                name: 'iPhone 12 Mini',
                description: 'Apple iPhone 12 Mini, 5.4-inch Super Retina XDR display, 5G',
                price: 9500000,
                categoryName: 'iPhone 12 Series',
            ...
            {
                name: 'iPhone 12 Pro',
                description: 'Apple iPhone 12 Pro, 6.1-inch Super Retina XDR display, triple camera',
                price: 14000000,
                categoryName: 'iPhone 12 Series',
            ...
            },
            {
                ...
                description: 'Apple iPhone 12 Pro Max, 6.7-inch Super Retina XDR display, triple camera',
                price: 16000000,
                categoryName: 'iPhone 12 Series',
            ...
            {
                name: 'iPhone 13',
                description: 'Apple iPhone 13, 6.1-inch Super Retina XDR display, A15 Bionic chip',
                price: 13000000,
            ...
            {
                name: 'iPhone 13 Mini',
                description: 'Apple iPhone 13 Mini, 5.4-inch Super Retina XDR display, A15 Bionic chip',
                price: 11500000,
                categoryName: 'iPhone 13 Series',
            ...
            {
                name: 'iPhone 13 Pro',
                description: 'Apple iPhone 13 Pro, 6.1-inch Super Retina XDR display, triple camera',
                price: 17000000,
                categoryName: 'iPhone 13 Series',
            ...
            },
            {
                ...
                description: 'Apple iPhone 13 Pro Max, 6.7-inch Super Retina XDR display, triple camera',
                price: 19000000,
                categoryName: 'iPhone 13 Series',
            ...
            {
                name: 'iPhone 14',
                description: 'Apple iPhone 14, 6.1-inch Super Retina XDR display, A15 Bionic chip',
                price: 12800000,
            ...
            {
                name: 'iPhone 14 Plus',
                description: 'Apple iPhone 14 Plus, 6.7-inch Super Retina XDR display, A15 Bionic chip',
                price: 17500000,
                categoryName: 'iPhone 14 Series',
            ...
            {
                name: 'iPhone 14 Pro',
                description: 'Apple iPhone 14 Pro, 6.1-inch Super Retina XDR display, Dynamic Island',
                price: 20000000,
                categoryName: 'iPhone 14 Series',
            ...
            },
            {
                ...
                description: 'Apple iPhone 14 Pro Max, 6.7-inch Super Retina XDR display, Dynamic Island',
                price: 23000000,
                categoryName: 'iPhone 14 Series',
            ...
            {
                name: 'iPhone 15',
                description: 'Apple iPhone 15, 6.1-inch Super Retina XDR display, USB-C',
                price: 19000000,
            ...
            {
                name: 'iPhone 15 Plus',
                description: 'Apple iPhone 15 Plus, 6.7-inch Super Retina XDR display, USB-C',
                price: 21000000,
                categoryName: 'iPhone 15 Series',
            ...
            {
                name: 'iPhone 15 Pro',
                description: 'Apple iPhone 15 Pro, 6.1-inch Super Retina XDR display, Titanium',
                price: 26000000,
                categoryName: 'iPhone 15 Series',
            ...
            },
            {
                ...
                description: 'Apple iPhone 15 Pro Max, 6.7-inch Super Retina XDR display, Titanium',
                price: 30000000,
                categoryName: 'iPhone 15 Series',
        ...
        for (const product of iphoneProducts) {
            ...
            if (category) {
                await database_1.default.product.create({
                    data: {
                        name: product.name,
                        slug: product.name
                            .toLowerCase()
        ...
        // Create a warehouse
        const warehouse = await database_1.default.warehouse.upsert({
