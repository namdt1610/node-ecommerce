...
class DashboardRepository {
    ...
    async getDashboardStats() {
        ...
        const [totalRevenue, totalOrders, totalUsers, totalProducts, totalCategories, orderStats, todayStats, newUsersToday, lowStockProducts,] = await Promise.all([
    ...
    async getSalesAnalytics(days = 30) {
        ...
        const formattedDailyRevenue = dailyRevenue.map((row) => ({
    ...
    async getProductAnalytics() {
        const [totalProducts, lowStockProducts, outOfStockProducts, topCategories, recentProducts,] = await Promise.all([
            this.prisma.product.count(),
